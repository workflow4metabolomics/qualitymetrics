...
# RUN cd /scripts && \
#    git clone -b release/${TOOL_VERSION} --recursive https://github.com/workflow4metabolomics/qualitymetrics.git
...
# set authorizations
RUN ["chmod", "a+x", "/scripts/qualitymetrics_wrapper.R"]
...
## ENTRYPOINT ["/scripts/qualitymetrics_wrapper.R"]
